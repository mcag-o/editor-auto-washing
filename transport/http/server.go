...
func (s *Server) registerRoutes() {
	...
	api := s.engine.Group("/api")
	{
		...
		api.POST("/articles/:id/workflow-template", apiArticlesHandler.AssignWorkflowTemplate)
		api.POST("/articles/:id/retry", apiArticlesHandler.Retry)
		api.POST("/articles/:id/stop", apiArticlesHandler.Stop)
		api.POST("/articles/:id/resume", apiArticlesHandler.Resume)
		api.DELETE("/articles/:id", apiArticlesHandler.Delete)
